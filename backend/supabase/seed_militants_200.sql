...
DECLARE
  ...
  -- Distribution pondérée (SS-075 la plus grande, puis SS-093, etc.)
  v_unites UUID[] := ARRAY[
    '00000000-0000-0000-0001-000000000075'::UUID, -- SS-075 Paris ×6
    '00000000-0000-0000-0001-000000000075'::UUID,
    '00000000-0000-0000-0001-000000000075'::UUID,
    '00000000-0000-0000-0001-000000000075'::UUID,
    '00000000-0000-0000-0001-000000000075'::UUID,
    '00000000-0000-0000-0001-000000000075'::UUID,
    '00000000-0000-0000-0001-000000000093'::UUID, -- SS-093 Seine-St-Denis ×4
    '00000000-0000-0000-0001-000000000093'::UUID,
    '00000000-0000-0000-0001-000000000093'::UUID,
    '00000000-0000-0000-0001-000000000093'::UUID,
    '00000000-0000-0000-0001-000000000092'::UUID, -- SS-092 Hauts-de-Seine ×2
    '00000000-0000-0000-0001-000000000092'::UUID,
    '00000000-0000-0000-0001-000000000094'::UUID, -- SS-094 Val-de-Marne ×1
    '00000000-0000-0000-0001-000000000091'::UUID, -- SS-091 Essonne ×1
    '00000000-0000-0000-0001-000000000077'::UUID, -- SS-077 Seine-et-Marne ×1
    '00000000-0000-0000-0001-000000000078'::UUID, -- SS-078 Yvelines ×1
    '00000000-0000-0000-0001-000000000095'::UUID, -- SS-095 Val-d'Oise ×1
    '00000000-0000-0000-0002-000000000001'::UUID, -- JPS ×1
    '00000000-0000-0000-0002-000000000002'::UUID  -- MOJIP ×1
  ];
...
BEGIN
  ...
  FOR i IN 1..200 LOOP
    ...
    v_prenom := CASE WHEN v_sexe = 'M'
                ...
                END;
    v_unite  := v_unites[1 + (floor(random() * array_length(v_unites, 1)))::INT];
